...
Files with extension ovf such as 'init_grid_cDW_1.ovf' and 'init_grid_cDW_2.ovf' are Open Virtualization Format files. They are used to initialise the magnetisation state of domains in the current-carrying nanowire. They were generated by running 'grid_1.mx3' and 'grid_2.mx3', respectively. 
